...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "tw-bg-background tw-group/calendar tw-p-3 tw-[--cell-size:2rem] [[data-slot=card-content]_&]:tw-bg-transparent [[data-slot=popover-content]_&]:tw-bg-transparent",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:tw-bg-primary data-[selected-single=true]:tw-text-primary-foreground data-[range-middle=true]:tw-bg-accent data-[range-middle=true]:tw-text-accent-foreground data-[range-start=true]:tw-bg-primary data-[range-start=true]:tw-text-primary-foreground data-[range-end=true]:tw-bg-primary data-[range-end=true]:tw-text-primary-foreground group-data-[focused=true]/day:tw-border-ring group-data-[focused=true]/day:tw-ring-ring/50 tw-flex tw-aspect-square tw-h-auto tw-w-full tw-min-w-[--cell-size] tw-flex-col tw-gap-1 tw-font-normal tw-leading-none data-[range-end=true]:tw-rounded-md data-[range-middle=true]:tw-rounded-none data-[range-start=true]:tw-rounded-md group-data-[focused=true]/day:tw-relative group-data-[focused=true]/day:tw-z-10 group-data-[focused=true]/day:tw-ring-[3px] [&>span]:tw-text-xs [&>span]:tw-opacity-70",
        defaultClassNames.day,
        className
      )}
      {...props}
